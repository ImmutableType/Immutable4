...
async function main() {
  console.log("Deploying LeaderboardAggregator V4 (Fixed GM Interface)...");
  ...
  // Deploy new LeaderboardAggregator V4
  const LeaderboardAggregator = await ethers.getContractFactory("LeaderboardAggregatorV4");
  ...
  console.log("LeaderboardAggregator V4 deployed to:", address);

  // Save deployment info
  const deploymentInfo = {
    address: address,
    contractName: "LeaderboardAggregatorV4",
    version: "v3",
  ...
  fs.writeFileSync(
    './deployments/LeaderboardAggregatorV4.json',
