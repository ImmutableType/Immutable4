        ...
        <div className="location-header" style={{
          ...
          <nav className="local-nav" style={{
            ...
            <ul style={{
              ...
              <li>
                <Link 
                  href={`/locations/${state}/${city}/journalists`}
                  style={{
                    padding: '8px 12px',
                    backgroundColor: subsection === 'journalists' ? '#F4F1E8' : 'white',
                    border: '1px solid #D9D9D9',
                    borderRadius: '4px',
                    textDecoration: 'none',
                    color: '#000000',
                    fontWeight: subsection === 'journalists' ? 'bold' : 'normal',
                    display: 'block'
                  }}
                >
                  Journalists
              ...
              <li>
                <Link 
                  href={`/locations/${state}/${city}/proposals`}
                  style={{
                    padding: '8px 12px',
                    backgroundColor: subsection === 'proposals' ? '#F4F1E8' : 'white',
                    border: '1px solid #D9D9D9',
                    borderRadius: '4px',
                    textDecoration: 'none',
                    color: '#000000',
                    fontWeight: subsection === 'proposals' ? 'bold' : 'normal',
                    display: 'block'
                  }}
                >
                  Proposals
              ...
              <li>
                <Link 
                  href={`/locations/${state}/${city}/community-curation`}
                  style={{
                    padding: '8px 12px',
                    backgroundColor: subsection === 'community-curation' ? '#F4F1E8' : 'white',
                    border: '1px solid #D9D9D9',
                    borderRadius: '4px',
                    textDecoration: 'none',
                    color: '#000000',
                    fontWeight: subsection === 'community-curation' ? 'bold' : 'normal',
                    display: 'block'
                  }}
                >
                  Community Curation
