            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.9rem', fontFamily: 'var(--font-ui)' }}>EMOJI Credits</span>
                  <strong style={{ color: '#e74c3c' }}>
                    {dashboardData.loading ? '...' : parseFloat(dashboardData.emojiBalance).toLocaleString()}
                  </strong>
                </div>
                ...
                <div style={{
                  ...
                  {/* Bookmarks Count - Real blockchain data */}
                  <div style={{
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center'
                    ...
                    <span style={{ fontSize: '18px', fontWeight: 'bold' }}>
                      {dashboardData.loading ? '...' : dashboardData.bookmarkCount}
                    </span>
                    <span style={{ fontSize: '12px', color: '#666' }}>Bookmarks</span>
                  </div>
                  
                  {/* Curated Posts - Real blockchain data */}
                  <div style={{
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center'
                    ...
                    <span style={{ fontSize: '18px', fontWeight: 'bold' }}>
                      {dashboardData.loading ? '...' : dashboardData.curatedCount}
                    </span>
                    <span style={{ fontSize: '12px', color: '#666' }}>Curated</span>
                  </div>
                  
                  {/* Leaderboard Score - Real blockchain data (SOURCE OF TRUTH) */}
                  <div style={{
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center',
                    ...
                    <div style={{ fontSize: '18px', fontWeight: 'bold', display: 'flex', alignItems: 'center' }}>
                      {dashboardData.loading ? '...' : (
                        dashboardData.userScore > 0 ? `Score: ${dashboardData.userScore}` : '—'
                      )}
                    </div>
                    <span style={{ fontSize: '12px', color: '#666' }}>Leaderboard</span>
                  </div>
                </div>
              </div>
            </div>
