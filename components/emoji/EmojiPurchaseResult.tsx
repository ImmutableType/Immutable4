// components/emoji/EmojiPurchaseResult.tsx
'use client';

import React, { useEffect } from 'react';

interface EmojiPurchaseResultProps {
  isVisible: boolean;
  isSuccess: boolean;
  emojiAmount?: number;
  flowPaid?: string;
...
export const EmojiPurchaseResult: React.FC<EmojiPurchaseResultProps> = ({
  isVisible,
  isSuccess,
  emojiAmount,
  flowPaid,
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            ...
            <div className={`mt-1 text-sm ${
              ...
              {isSuccess ? (
                <>
                  +{emojiAmount?.toLocaleString()} EMOJI for {flowPaid} FLOW
                </>
              ) : (
